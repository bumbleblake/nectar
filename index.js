...
client.on("guildMemberAdd", member => {
  if(member.guild.id == "489673739475353600" || member.guild.id == "458556394858348564"){
        member.addRole(member.guild.roles.find("name", "member").id);
        var welcome = client.channels.get('490730592191643648') || client.channels.get('458565595378614292');
